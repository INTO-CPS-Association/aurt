...
if __name__ == '__main__':
    ...
    if args.run_tests == "slow_tests":
        ...
        runner = unittest.TextTestRunner()
        res = runner.run(suite)
    elif args.run_tests == "all-non-live":
        suite = unittest.TestSuite()
        suite.addTest(unittest.TestLoader().discover("aurt/tests", pattern="*test*.py"))
        suite.addTest(unittest.TestLoader().discover("tests/slow_tests", pattern="*test*.py"))
        runner = unittest.TextTestRunner()
        res = runner.run(suite)
