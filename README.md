...
with <img src="https://render.githubusercontent.com/render/math?math=b_n=|\dot{q}|\,\dot{q}^{n-1}"> if <img src="https://render.githubusercontent.com/render/math?math=n"> is even and <img src="https://render.githubusercontent.com/render/math?math=b_n=\dot{q}^n"> otherwise.
